...
namespace Squirrel
{
    public sealed partial class UpdateManager
    {
        ...
        public static async Task<UpdateManager> NutsUpdateManager(
            string url,
            string applicationName = null,
            string rootDirectory = null,
            IFileDownloader urlDownloader = null,
            ...
            string accessToken = null)
        {
            ...
            if (repoUri.Segments.Length != 1)
            {
                throw new Exception("Nuts URL must be to the root URL of host e.g. https://updates.mydomain.com/");
            }
